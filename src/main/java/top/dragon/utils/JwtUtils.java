...
import top.dragon.adviceException.DragonException;
...
public  class JwtUtils {
    ...
    private final static String jwtKey = "ab034779-d0a6-4924-af09-6ba63a1b697d";
    ...
    public String createJwtToken(Long validity,String name, Object value) {
        Map<String, Object> parameterMap = new HashMap<>();
